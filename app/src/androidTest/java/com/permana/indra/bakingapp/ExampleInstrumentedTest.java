...
public class ExampleInstrumentedTest {
    ...
    public void useAppContext() throws Exception {
        ...
        assertEquals("com.permana.indra.bakingapp", appContext.getPackageName());
    }

    @Test
    public void textTest() {
        onView(ViewMatchers.withId(R.id.recipe_RV)).perform(RecyclerViewActions.scrollToPosition(2));
